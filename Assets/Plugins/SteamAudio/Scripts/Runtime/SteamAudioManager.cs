...
namespace SteamAudio
{
    ...
    public class SteamAudioManager : MonoBehaviour
    {
        ...
        public static void Initialize(ManagerInitReason reason)
        {
            if (sSingleton != null)
            {
                Debug.Log($"[Steam Audio] Manager already exists. Skipping creation.");
            }
            ...
            try
            {
                ...
                Debug.Log("[Steam Audio] Initialization successfull!");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[Steam Audio] Initialization failed: {ex.Message}");
            }
        }
